...
v0.1 components:
  ...
  RetentionCurve    — cohort retention percentages over time

v0.2 (planned):
  InvestorMetrics   — NDR, GRR, LTV, CAC payback, Magic Number

v0.3 (planned):
  MRRMovement       — new/expansion/contraction/churn/reactivation
  ActivationFunnel  — multi-step funnel with conversion rates
"""
